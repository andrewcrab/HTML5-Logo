...
(function(){
    ...
    (function(){
        ...
        ac.canvas.myCanvas.addEventListener("mousedown",onMouseDown);
        ac.canvas.myCanvas.addEventListener("mousemove",onMouseMove);
        ac.canvas.myCanvas.addEventListener("mouseup",onMouseUp);
        ...
        var Image = draggable.Image = function(src,x,y){
            ...
            this.draw = function(){
                //ac.canvas.drawImage(this.src,this.x,this.y);
                ac.canvas.drawImage(src,x,y);
            };
        };
    })();
    /*
